...
public class TestRegister extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog = new ProgressDialog(TestRegister.this);
        ...
        nextRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                // If EditText is false then this block with execute.
                    ...
                    Toast.makeText(TestRegister.this, "Please fill all form fields.", Toast.LENGTH_LONG).show();
    ...
    public void UserRegistrationFunction(){
        ...
        mAuth.createUserWithEmailAndPassword(emailHolder, passwordHolder).
                addOnCompleteListener(TestRegister.this, new OnCompleteListener<AuthResult>() {
                    @Override
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if(task.isSuccessful()){
                            ...
                            Toast.makeText(TestRegister.this,"User Registration Successfully",Toast.LENGTH_LONG).show();
                            finish();
                            Intent intent = new Intent(TestRegister.this, RegistrationActivity.class);
                            ...
                            Toast.makeText(TestRegister.this,"Something Went Wrong.",Toast.LENGTH_LONG).show();
                        }
